    ...
    <nav aria-label="Main navigation" className="flex-shrink-0 bg-gray-900 border-t border-gray-700 px-3 pt-2" style={{ paddingBottom: 'max(0.75rem, env(safe-area-inset-bottom))' }}>
      ...
      <div className="relative mb-2">
        <input
          ...
          className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-base text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
        />
      </div>
      ...
      <div className="flex items-center justify-around">
        ...
        <button onClick={() => navigate('/wall')} className="text-gray-400 p-2" aria-label="Wall photos">
          <svg viewBox="0 0 640 640" className="w-7 h-7" fill="currentColor" aria-hidden="true">
        ...
        >
          <svg viewBox="0 0 640 640" className="w-9 h-9" fill="currentColor" aria-hidden="true">
