...
export default function ProblemRow({ problem, onTap }: ProblemRowProps) {
  return (
    ...
    >
      {/* Left: name, sends, project */}
      <div className="flex-1 min-w-0">
        <span className="text-white text-lg font-semibold truncate block">{problem.name}</span>
      ...
      <div className="flex flex-col items-end flex-shrink-0">
        <span className="text-white text-lg font-mono font-semibold">{problem.grade}</span>
        {problem.rating !== null && (
